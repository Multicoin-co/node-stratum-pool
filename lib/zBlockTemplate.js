...
var merklebitcoin = util.denodeify(require('merkle-bitcoin'));
...
**/
var BlockTemplate = module.exports = function BlockTemplate(jobId, rpcData, extraNoncePlaceholder, recipients, poolAddress, poolHex, coin) {
    //private members
    var submits = [];
